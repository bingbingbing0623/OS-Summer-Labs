...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a4:	48050513          	addi	a0,a0,1152 # 820 <digits>
 3a8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 470:	3b4b8b93          	addi	s7,s7,948 # 820 <digits>
 ...
 5b0:	26c90913          	addi	s2,s2,620 # 818 <malloc+0x126>
        while(*s != 0){
...
free(void *ap)
{
 ...
 678:	1c47b783          	ld	a5,452(a5) # 838 <freep>
 ...
 6a6:	00e6ea63          	bltu	a3,a4,6ba <free+0x50>
{
 ...
 6e8:	14f73a23          	sd	a5,340(a4) # 838 <freep>
}
 6ec:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 71a:	12253503          	ld	a0,290(a0) # 838 <freep>
 ...
 742:	0fa90913          	addi	s2,s2,250 # 838 <freep>
  if(p == (char*)-1)
 746:	5afd                	li	s5,-1
 748:	a88d                	j	7ba <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 74a:	00000797          	auipc	a5,0x0
 74e:	0f678793          	addi	a5,a5,246 # 840 <base>
 752:	00000717          	auipc	a4,0x0
 756:	0ef73323          	sd	a5,230(a4) # 838 <freep>
 75a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 77c:	0ca73023          	sd	a0,192(a4) # 838 <freep>
      return (void*)(p + 1);
